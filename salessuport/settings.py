"""
Django settings for salessuport project.
...
WSGI_APPLICATION = "salessuport.wsgi.application"
...
AUTHENTICATION_BACKENDS = (
    'user_profile.authorization.JobSeekerBackend', 
    'employer.authorization.EmployerBackend',
